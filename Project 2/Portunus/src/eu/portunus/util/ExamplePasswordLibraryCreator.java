...
public class ExamplePasswordLibraryCreator {
    ...
    public IPasswordLibrary createExampleLibrary(IPortunusFactory factory) {
        ...
        IPasswordRecord bankRecord = createPasswordRecord(
            factory,
            "Bank",
            "MrMoneyMaker",
        ...
        IPasswordRecord amazonRecord = createPasswordRecord(
            factory,
            "Amazon",
            "ShoeShopper0815",
            "ShoppingIsMyLife",
        ...
        IPasswordGroup professionalGroup = factory.createPasswordGroup(
            "Professional"
        );
        passwordLibrary.addEntry(professionalGroup);

        IPasswordRecord googleRecord = createPasswordRecord(
            factory,
            "Google",
            "peter@gmail.com",
            "SuperSecurePassword",
        ...
        IPasswordGroup collaborationsGroup = factory.createPasswordGroup(
            "Collaborations"
        );
        professionalGroup.addEntry(collaborationsGroup);

        IPasswordRecord workServerRecord = createPasswordRecord(
            factory,
            "Work Server",
            "Admin",
            "admin123"
    ...
    private static IPasswordRecord createPasswordRecord(
