...
public class AESCrypter implements ICrypter {
    ...
    @Override
    public String encrypt(String plainTextToEncrypt, String plainKey)
        ...
        try {
            ...
            byte[] decryptedDecodedBytes = decryptedDecodedString.getBytes(
                "UTF-8"
            );
            byte[] encryptedDecodedBytes = cipher.doFinal(
                decryptedDecodedBytes
            );

            String encryptedEncodedString = Base64
                .getEncoder()
                .encodeToString(encryptedDecodedBytes);
    ...
    @Override
    public String decrypt(String encryptedTextToDecrypt, String plainKey)
        ...
        try {
            ...
            byte[] encryptedDecodedBytes = Base64
                .getDecoder()
                .decode(encryptedEncodedString);
            byte[] decryptedDecodedBytes = cipher.doFinal(
                encryptedDecodedBytes
            );
