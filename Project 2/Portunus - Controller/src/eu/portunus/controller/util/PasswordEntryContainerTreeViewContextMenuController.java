...
public class PasswordEntryContainerTreeViewContextMenuController {
    ...
    public PasswordEntryContainerTreeViewContextMenuController(
        PasswordEntryContainerTreeViewContextMenu contextMenu,
    ...
    protected void initializeControls() {
        PasswordEntryContainerTreeView passwordEntryContainerTreeView = parentController
            .getView()
    ...
    protected void registerListeners() {
        ...
        contextMenu
            .getEditPasswordGroupMenuItem()
            .setOnAction(
                new EventHandler<ActionEvent>() {
                    @Override
                    public void handle(ActionEvent event) {
                        IPasswordGroup selectedPasswordGroup = parentController.getSelectedPasswordGroup();
                        parentController.editPasswordGroup(
                            selectedPasswordGroup
                        );
                    }
                }
        ...
        contextMenu
            .getDeletePasswordGroupMenuItem()
            .setOnAction(
                new EventHandler<ActionEvent>() {
                    @Override
                    public void handle(ActionEvent event) {
                        IPasswordGroup selectedPasswordGroup = parentController.getSelectedPasswordGroup();
                        parentController.deletePasswordGroup(
                            selectedPasswordGroup
                        );
                    }
                }
