...
public class ErrorUtil {
    ...
    public static void showFactoryMethodError(
        Class<?> interfaceToInstantiate,
        String additum
    ) {
        ...
        message +=
            "Instance of \"" +
            interfaceToInstantiateName +
            "\" could not be created.\n\n";
        message +=
            "Did you implement the respective factory method of \"" +
    ...
    public static void showError(String message) {
        ...
        stage
            .getIcons()
            .addAll(ImageLibrary.getInstance().getApplicationImages());
