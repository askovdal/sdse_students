...
public class PasswordRecordTableView extends TableView<IPasswordRecord> {
    ...
    private void initializeControl() {
        ...
        addColumn(
            "Password",
            150,
            new PasswordRecordPasswordCellValueFactory()
        );
        addColumn("URL", 150, "url");
    }

    private TableColumn<IPasswordRecord, ?> addColumn(
        String name,
        int preferredWidth,
        String propertyName
    ) {
        ...
        column.setCellValueFactory(
            new PropertyValueFactory<IPasswordRecord, String>(propertyName)
        );
    ...
    private <T> TableColumn<IPasswordRecord, T> addColumn(
        String name,
        int preferredWidth,
